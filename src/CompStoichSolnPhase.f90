...
subroutine CompStoichSolnPhase(k)
    ...
    LOOP_A: do i = m, n
        ! Pulling this calculation out of loop improves efficiency
        dTemp = dMolFraction(i) / DFLOAT(iParticlesPerMole(i))
        ! Can save a lot of cycles by neglecting really low-weight components
