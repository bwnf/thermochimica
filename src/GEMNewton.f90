...
subroutine GEMNewton(INFO)
    ...
    integer                              :: i, j, k, l, m, INFO, nVar, LWORK
    ...
    ! call dposv('U', nVar, 1, A, nVar, B, nVar, INFO )
    call dsysv('U', nVar, 1, A, nVar, IPIV, B, nVar, WORK, LWORK, INFO )
    ! call ArrowSolver(nConPhases + nSolnPhases, nVar, A, B, INFO)
    ...
    i = 0
    deallocate(A, B, IPIV, WORK, STAT = i)
